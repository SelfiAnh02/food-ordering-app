...
import { createOrderKasir, getAllOrders, getOrderById, updateOrderStatus } from "../../controllers/staff/orderController.js";
...
staffOrderRouter.put("/:id", authStaff, updateOrderStatus);
